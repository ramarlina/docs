...
<CardGroup cols={3}>
  ...
  <Card title="Opt-in Cloud" icon="cloud">
    Sync across devices and publish your profile only when you choose to.
  </Card>
</CardGroup>
...
> Every two weeks, our PM would ask 'what did the team ship?' and we'd scramble to remember. Now I just run `repr since "2 weeks ago"` on Friday afternoon and export it as our sprint summary.
>
...
[See privacy-first setup →](/guides/local-only)

### "My weekly 1-on-1s with my manager are 10x better"

> I used to show up with vague 'I worked on some bug fixes.' Now I run `repr week` before every 1-on-1. I have specific examples of what I shipped, with context.
>
...
- **Automated Standups**: Forget what you did yesterday? `repr standup` has your back.
- **Performance Reviews**: Generate a 3-month summary of your impact with one command.
- **Interview Prep**: Turn your actual code contributions into STAR-format stories.
- **Sprint Demos**: Export professional changelogs for stakeholders in seconds.
- **Privacy Control**: Use entirely offline with local models for sensitive work.
