...
| Command | What It Does |
|---------|-------------|
| `repr week` | Show last 7 days of work |
| `repr standup` | Show last 3 days (transient - not saved) |
| `repr since DATE` | Show work since specific date |
| `repr since DATE --save` | Save summary as permanent story |
| `repr commits` | Show recent commits |
| `repr commits --limit N` | Show last N commits |

**Examples:**
```bash
repr week                        # Last 7 days
repr standup                     # Quick 3-day summary
repr since "monday"              # Since Monday
repr since "this morning" --save # Save today's work
...
```bash
repr standup              # Morning check
# ... do work ...
repr since "this morning" --save  # End of day
```
