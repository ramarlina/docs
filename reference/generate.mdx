...
| `--commits <shas>` | Comma-separated commit SHAs to generate from | Recent commits (last 90 days) |
...
1. **Selects commits** - From the hook queue, specific SHAs, or recent history
